...
VALUES
 ...
 -- Query to display all employee data 
...
FROM
  Employee e
  LEFT JOIN LatestPositionHistory lph ON e.EmployeeId = lph.EmployeeId
  LEFT JOIN PositionHistory ph ON lph.EmployeeId = ph.EmployeeId AND lph.MaxStartDate = ph.StartDate;
